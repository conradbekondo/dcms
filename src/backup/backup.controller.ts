import { Controller, Get, Inject, Logger, Post, Render, UseFilters, UseGuards } from '@nestjs/common';
...
const BACKUP_FOLDER_PATH = 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\';
